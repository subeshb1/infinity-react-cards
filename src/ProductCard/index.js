      ...
      <div className="content">
        ...
        <div className="details">
          <div className="head">
            ...
            <div className="detail">How I thought my life would be tomorow</div>
          </div>
          <div className="tail">
            <div className="group">
              <div className="name">Sizes</div>
              <div className="detail">XL, XXL, XXXL</div>
            </div>
            <div className="group">
              <div className="name">Color</div>
              <div className="detail">XL,XXl,ML</div>
            </div>
          </div>
        </div>
      </div>
      <div className="control">
        <div className="item" data-tooltip="Cart">
          <svg
        ...
        <div className="item" data-tooltip="Wishlist">
          <svg
            xmlns="http://www.w3.org/2000/svg"
            width="24"
            height="24"
        ...
        <div className="item" data-tooltip="Review">
          <svg
            xmlns="http://www.w3.org/2000/svg"
            width="24"
            height="24"
        ...
        <div className="item" data-tooltip="Share">
          <svg
            xmlns="http://www.w3.org/2000/svg"
            width="24"
            height="24"
